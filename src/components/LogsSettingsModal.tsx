...
import {LOG_LEVEL, LOGS_TABLE_MAX_ROWS_LIST, TAILWINDCSS_SIZE,} from '~/constants'
import {useI18n} from '~/i18n'
import {logLevel, logMaxRows, logsTableSize, setLogLevel, setLogMaxRows, setLogsTableSize,} from '~/signals'
