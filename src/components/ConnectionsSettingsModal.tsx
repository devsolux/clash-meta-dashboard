...
import type {DragEventHandler, Draggable, Droppable,} from '@thisbeyond/solid-dnd'
import {closestCenter, createSortable, DragDropProvider, DragDropSensors, DragOverlay, SortableProvider, transformStyle, useDragDropContext,} from '@thisbeyond/solid-dnd'
import {uniq} from 'lodash'
import {Component, createSignal, For, Index, Show} from 'solid-js'
import {z} from 'zod'
import {Button, ConfigTitle, Modal} from '~/components'
import {CONNECTIONS_TABLE_ACCESSOR_KEY, CONNECTIONS_TABLE_INITIAL_COLUMN_ORDER, CONNECTIONS_TABLE_INITIAL_COLUMN_VISIBILITY, TAILWINDCSS_SIZE,} from '~/constants'
import {useI18n} from '~/i18n'
import {allConnections, clientSourceIPTags, connectionsTableSize, setClientSourceIPTags, setConnectionsTableSize,} from '~/signals'
import {ConnectionsTableColumnOrder, ConnectionsTableColumnVisibility,} from '~/types'
