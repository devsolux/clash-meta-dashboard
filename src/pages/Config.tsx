...
import {Accessor, Component, createEffect, createResource, createSignal, For, onMount, Show,} from 'solid-js'
...
import {autoSwitchTheme, endpoint, favDayTheme, favNightTheme, setAutoSwitchTheme, setFavDayTheme, setFavNightTheme, setSelectedEndpoint, setUseTwemoji, useRequest, useTwemoji,} from '~/signals'
...
export default () => {
  ...
  return (
    <div class="mx-auto flex max-w-screen-md flex-col gap-4">
      ...
      <ConfigTitle withDivider>{t('metaConfig')}</ConfigTitle>
