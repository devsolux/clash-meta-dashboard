import {IconBrandSpeedtest, IconReload, IconSettings,} from '@tabler/icons-solidjs'
import {createMemo, createSignal, For, onMount, Show} from 'solid-js'
import {twMerge} from 'tailwind-merge'
import {Button, Collapse, ProxiesSettingsModal, ProxyNodeCard, ProxyNodePreview, SubscriptionInfo,} from '~/components'
import {filterProxiesByAvailability, sortProxiesByOrderingType,} from '~/helpers'
import {useI18n} from '~/i18n'
import {formatTimeFromNow, hideUnAvailableProxies, proxiesOrderingType, renderProxiesInTwoColumns, useProxies,} from '~/signals'
